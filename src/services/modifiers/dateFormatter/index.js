    ...
    formParams: [
      {
        ...
        description:
          "Select a predefined format or choose 'Custom' to specify your own.",
        inputType: "radio",
        rules: ["required"],
        options: [
          {
          ...
          {
            id: "european",
            label: "European (dd/MM/yyyy HH:mm:ssXXX)",
            value: "european",
          },
      ...
      },
      {
        ...
        infoText:
          "Allowed tokens: yyyy (year), MM (month number), MMMM (month text), dd (day), HH (hour 24h), " +
      ...
      },
      {
        ...
        label: "Detail level",
        description:
          "Define the level of detail to include in the formatted output. Available options are " +
          "determined by the selected format type.",
        inputType: "select",
        rules: ["required"],
        dependsOn: {
          and: [{ field: "formatType", value: ["iso", "european", "us"] }],
        },
        options: [
          { id: "year", label: "Year only (yyyy)", value: "year" },
          {
            id: "monthYear",
            label: "Month-Year only (MM-yyyy)",
            value: "monthYear",
          },
          {
            id: "monthNumber",
            label: "Month number only (MM)",
            value: "monthNumber",
          },
          {
            id: "monthText",
            label: "Month text only (MMMM)",
            value: "monthText",
          },
          ...
          {
            id: "milliseconds",
            label: "Milliseconds only (SSS)",
            value: "milliseconds",
          },
          {
            id: "hourMinutes",
            label: "Hour and minutes (HH:mm)",
            value: "hourMinutes",
          },
          {
            id: "hourMinutes12",
            label: "Hour and minutes 12h (hh:mm a)",
            value: "hourMinutes12",
          },
          {
            id: "hourSeconds",
            label: "Hour with seconds (HH:mm:ss)",
            value: "hourSeconds",
          },
          {
            id: "hourSecondsUTC",
            label: "Hour with seconds UTC (HH:mm:ss'Z')",
            value: "hourSecondsUTC",
          },
          {
            id: "hourSeconds12",
            label: "Hour with seconds 12h (hh:mm:ss a)",
            value: "hourSeconds12",
          },
          {
            id: "hourMilliseconds",
            label: "Hour with milliseconds (HH:mm:ss.SSS)",
            value: "hourMilliseconds",
          },
          {
            id: "timezone",
            label: "Hour with timezone and offset (HH:mm:ssXXX) [e.g., +02:00]",
            value: "timezone",
          },
          {
            id: "timezoneAbbr",
            label: "Hour with timezone GMT (HH:mm:ss z) [e.g., GMT+2]",
            value: "timezoneAbbr",
          },
        ],
      },
      {
        ...
        label: "Output mode",
        description:
          "Choose whether to create a new column or overwrite existing values.",
        inputType: "radio",
        defaultValue: "edit",
        options: [
